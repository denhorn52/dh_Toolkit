...
--zzprop
    ...
    col_values      = {prop = "col_values",      caption = "Values Color",    class = "Color",   needs_init = true},
...
classes.dh_Graph = {
    ...
    creation = {"w", "h", "", 
        "caption", "font_caption", "cap_pad_x", "cap_pad_y",
        "cap_centered", "shadow_caption", "shadow",
        "grid_x_divs", "grid_y_divs", "y_min", "y_max", "y_ref", "graph_labels", --"y_scale",
    ...
    properties = {
        ...
        {prop = "y_min",          caption = "Y scale min",  class = "Integer",  needs_init = true},        
        {prop = "y_max",          caption = "Y scale max",  class = "Integer",  needs_init = true},        
        {prop = "y_ref",          caption = "Y scale ref",  class = "Integer",  needs_init = true},        
        --{prop = "y_scale",      caption = "Y scale",      class = "Number",   needs_init = true},        
        --{prop = "data_points",  caption = "Data points",  class = "Table",    needs_init = false},
        --{prop = "ref_points",   caption = "Ref. points",  class = "Table",    needs_init = false},
        ...
        props.shadow,
        "",
        {prop = "graph_labels",   caption = "X labels",     class = "Editor",   needs_init = true,   subclass = "graph_labels"},
        --{prop = "y_labels",       caption = "Y labels",     class = "Editor",   needs_init = true},
        {prop = "font_text",      caption = "Labels Font",  class = "Font",     needs_init = true},
        props.pad,
--zzcolors
        "3",
        --props.col_bg,
