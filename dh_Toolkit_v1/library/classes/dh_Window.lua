...
--   Used to display a sub-window for preferences, etc.
...
---------------------------------------------------------------------
GUI.dh_Window = GUI.Element:new()
function GUI.dh_Window:new(name, z, x, y, w, h, caption, z_set, center) -- Add your own params here
...
function GUI.dh_Window:ondelete()
...
function GUI.dh_Window:onupdate()
...
function GUI.dh_Window:onmouseup()
...
function GUI.dh_Window:onmouseover()
...
function GUI.dh_Window:drawbackground()
...
function GUI.dh_Window:drawwindow()
...
function GUI.dh_Window:adjustchildelms(force)
...
function GUI.dh_Window:mouseoverclose()
...
function GUI.dh_Window:blitwindow()
...
function GUI.dh_Window:hidelayers()
...
function GUI.dh_Window:showlayers()
...
function GUI.dh_Window:getchildelms()
