...
--[[ Modified Lokasenna_GUI Class - Slider.lua  
     by Dennis Horn 2025-03-25.

     Added ability to adjust track thickness and handle sizes.
...
function GUI.dh_Slider:init()
    ...
    -- x, y, w, h, radius
    GUI.color("elm_bg")
    GUI.roundrect(2, 2, w, self.thk, self.thk / 2, 1, 1)
    GUI.color("elm_outline")
    GUI.roundrect(2, 2, w, self.thk, self.thk / 2, 1, 0)
